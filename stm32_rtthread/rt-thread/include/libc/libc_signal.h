...
/* If the system <signal.h> already provides sigevent/siginfo/etc
 * (newlib and other C libraries usually define SIGEV_NONE), skip
 * RT-Thread's internal definitions to avoid redefinition errors. */
